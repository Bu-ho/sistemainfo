...
if (isset($_POST['BTNcambio'])) {
    ...
    $sql = "UPDATE padres_familia SET nombre_completo_padre='$nombre_completo_padre', apellido_completo_padre='$apellido_completo_padre', fecha_nacimiento='$fecha_nacimiento', sexo='$sexo_e', direccion_residencia='$direccion_residencia', tipo_documento='$tipo_documento', alergias='$alergias', enfermedades='$enfermedades', eps='$eps', estrato='$estrato', telefono='$telefono', correo='$correo', contrasena='$contrasena' WHERE numero_identificacion='$numero_identificacion'";
    ...
    if ($result === false) {
        ...
        Swal.fire({
            ...
            window.location.href = 'padatosinicio.php';
        });
    </script>";
    } else {
        mysqli_close($con);
