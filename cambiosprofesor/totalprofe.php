...
$queryTotal = mysqli_query($con, "SELECT COUNT(*) AS total_profesor FROM profesores");
$totalprofesores = mysqli_fetch_array($queryTotal);

$query = mysqli_query($con, "SELECT numero_identificacion, nombre_completo_profesor, apellido_completo_profesor, t_usuario FROM profesores");
?>
...
<body>
    ...
    <div class="container m-5">
        <h2 class="text-center"> Total de profesores registrados</h2>
        <div class="card m-5">
            <div class="card-header">
                Total de padres: <?php echo $totalprofesores['total_profesor']; ?>
            </div>
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        while ($profesores = mysqli_fetch_array($query)) {
                        ?>
                            <tr>
                                <td><?php echo $profesores['numero_identificacion']; ?></td>
                                <td><?php echo $profesores['nombre_completo_profesor']; ?></td>
                                <td><?php echo $profesores['apellido_completo_profesor']; ?></td>
                                <td><?php echo $profesores['t_usuario']; ?></td>
                            </tr>
                        <?php
                        }
                        ?>
